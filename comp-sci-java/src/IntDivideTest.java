...
class IntDivideTest {
    public static void main(String[] dolbyAtmos) {                                   // GANTI2 SI "args"
        Scanner scan = new Scanner(System.in);
        int dividend, divisor;                                              // int version of input
        ...
        System.out.println(quotient + " * " + divisor + " + " + remainder + " is " + (quotient * divisor + remainder));
    }
}
